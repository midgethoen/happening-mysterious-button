...
things = [
  ...
  "een toffe peer"
  "een fijne knul"
  "niet onaangenaam om naar te kijken"
]
randomThing = ->
...
exports.render = ->
	...
	Dom.section !->
    Dom.h1 "Mysterieuze knop"
    Ui.button "Druk hier", !->
      if Plugin.userName() != 'Jeffrey'
        Server.call 'press', {userId:Plugin.userId(), thing:randomThing()}


  Dom.section !->
    Ui.list !->
      Db.shared.iterate 'things', (thing) !->
        Ui.item !->
          Dom.text thing.get()
